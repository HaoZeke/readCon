...
TEST_CASE("AtomDatum Constructor") {
  yodecon::types::AtomDatum atom("O", 1.0, 2.0, 3.0, false, 1);
...
TEST_CASE("ConFrame Constructor") {
  ...
  yodecon::types::AtomDatum atom("O", 10.477713, 12.379463, 12.871778, false,
                                 1);
...
TEST_CASE("ConFrame AtomicSymbolsRoundTrip") {
  ...
  yodecon::types::ConFrame conFrame;
  conFrame.atom_data.push_back(
      yodecon::types::AtomDatum("H", 1.0, 2.0, 3.0, false, 1));
  conFrame.atom_data.push_back(
      yodecon::types::AtomDatum("C", 4.0, 5.0, 6.0, false, 2));
  conFrame.atom_data.push_back(
      yodecon::types::AtomDatum("O", 7.0, 8.0, 9.0, false, 3));
...
TEST_CASE("ConFrameTest CreateSingleCon_SingleFile") {
  ...
  auto result = yodecon::create_single_con<yodecon::types::ConFrame>(a_fconts);
...
TEST_CASE("ConFrameTest CreateMultiCon") {
  ...
  // Call the function under test.
  std::vector<yodecon::types::ConFrame> results =
      yodecon::create_multi_con<yodecon::types::ConFrame>(a_fconts);
